...
public class Solution {
    ...
    static int[] solve(int a0, int a1, int a2, int b0, int b1, int b2) {
        ...
        int aliceScore = 0;
        int bobScore = 0;
        int[] aliceConsolidatedScores = new int[]{a0,a1,a2};
        int[] bobConsolidatedScores = new int[]{b0,b1,b2};
        
        for (int i = 0; i < numOfInteger ;i++){
            if (aliceConsolidatedScores[i] > bobConsolidatedScores[i]){
                aliceScore++;
            }else if (aliceConsolidatedScores[i] < bobConsolidatedScores[i]){
                bobScore++;
            }else{
                continue;
            }
